...
import com.restore.trashfiles.adapter.VideoAdapter
import com.restore.trashfiles.adapter.PreviewVideoAdapter
                    ...
                    if (recoverToGallery(sourceFile, recoveredFileName)) {
                        ...
                        try {
                            ...
                            if (!db.fileExists(destFile.absolutePath)) {
                                val id = db.addRecoveredFile(recoveredFileObj, com.restore.trashfiles.db.RecoveredFilesDatabase.TYPE_VIDEO)
